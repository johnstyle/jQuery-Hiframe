Hiframe est un plugin jQuery permettant de redimensionner automatiquement la hauteur d’une iframe suivant son contenu et d’éviter ainsi d’avoir la fameuse barre de défilement (srcoll).
